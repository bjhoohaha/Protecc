          ...
          <v-card class="elevation-12">
            ...
            <p v-else>
              <v-card-text>
                <v-form>
                  <!-- email text field -->
                  <v-text-field v-model="email" prepend-icon="person"
                      name="login" label="Login" type="email"></v-text-field>
                  <!-- password text field -->
              ...
              <v-card-actions>
                ...
                <v-btn @click="loginWithEmail = !loginWithEmail" color="white">
                  Back</v-btn>
                <!-- create account -->
                <v-btn light to="/sign-up" color="white">Create Account</v-btn>
                <!-- submit form -->
                <v-spacer></v-spacer>
                <v-btn dark @click="login()" color="grey darken-2">Login</v-btn>
              </v-card-actions>
            </p>
            <!-- end of form -->
          </v-card>
