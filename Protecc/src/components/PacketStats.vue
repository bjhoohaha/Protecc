  ...
  <v-container>
    <v-layout>
      ...
      <v-flex xs8 md6 lg8>
        ...
        <br />
        <!-- table for dates -->
        <v-data-table :headers="dateHeader" v-bind:items="dateTableValues"
            item-key="date">
    ...
    <v-layout>
      ...
      <v-flex xs6>
        ...
        <!-- table for length -->
        <v-data-table :headers="lengthHeader" v-bind:items="lengthTableValues"
            item-key="date">
          <template v-slot:items="props">
      ...
      <v-flex xs6>
        ...
        <!-- table for count -->
        <v-data-table :headers="protocolHeader"
            v-bind:items="protocolTableValues" item-key="date">
          <template v-slot:items="props">
